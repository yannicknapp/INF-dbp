...
public class Bestellung {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        System.out.println("Wälen Sie die 1 um etwas beim Kunden zu ändern");
        System.out.println("Wälen Sie die 2 um die Bestellungen zu ändern");
        System.out.println("Wälen Sie die 3 um die Adressen zu ändern");
        System.out.println("Wälen Sie die 4 um die Artikel zu ändern");
